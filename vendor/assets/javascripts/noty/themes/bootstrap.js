		...
		style: function() {
			...
			switch (this.options.type) {
				...
				case 'success':
					...
					this.$buttons.css({borderTop: '1px solid #D6E9C6'});break;
				default:
					this.$bar.css({backgroundColor: '#FFF', borderColor: '#CCC', color: '#444'}); break;
			}
		},
		callback: {
			onShow: function() { $.noty.themes.bootstrap.helpers.borderFix.apply(this); },
			onClose: function() { $.noty.themes.bootstrap.helpers.borderFix.apply(this); }
		}
	};
